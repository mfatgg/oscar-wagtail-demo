    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option_group', models.ForeignKey(on_delete=models.CASCADE, null=True, verbose_name='Option Group', help_text='Select an option group if using type "Option"', to='catalogue.AttributeOptionGroup', blank=True)),
            ],
            options={
                'ordering': ['code'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Attribute', to='catalogue.ProductAttribute')),
                ('entity_content_type', models.ForeignKey(on_delete=models.CASCADE, null=True, editable=False, to='contenttypes.ContentType', blank=True)),
                ('product', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Product', related_name='attribute_values', to='catalogue.Product')),
                ('value_option', models.ForeignKey(on_delete=models.CASCADE, null=True, verbose_name='Value option', to='catalogue.AttributeOption', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Category', to='catalogue.Category')),
                ('product', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Product', to='catalogue.Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date created')),
                ('product', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Product', related_name='images', to='catalogue.Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Primary product', related_name='primary_recommendations', to='catalogue.Product')),
                ('recommendation', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Recommended product', to='catalogue.Product')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='product_class',
            field=models.ForeignKey(on_delete=models.CASCADE, null=True, verbose_name='Product type', related_name='attributes', to='catalogue.ProductClass', blank=True),
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(on_delete=models.CASCADE, verbose_name='Group', related_name='options', to='catalogue.AttributeOptionGroup'),
            preserve_default=True,
        ),
    ]
