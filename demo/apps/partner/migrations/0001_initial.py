    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Country', to='address.Country')),
                ('partner', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Partner', related_name='addresses', to='partner.Partner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Partner', related_name='stockrecords', to='partner.Partner')),
                ('product', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Product', related_name='stockrecords', to='catalogue.Product')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='stockrecord',
            field=models.ForeignKey(on_delete=models.CASCADE, verbose_name='Stock Record', related_name='alerts', to='partner.StockRecord'),
